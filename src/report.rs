...
mod tests {
    ...
    fn rendering_is_deterministic_and_embeds_data() {
        let result = serde_json::json!({"summary":{"completed_requests":1,"abandoned_requests":0,"requests_per_sec":1.0,"status_errors":0,"read_bytes":0},"latency":{"minimum_us":null,"maximum_us":null,"average_us":null,"median_us":null,"p90_us":null,"p95_us":null,"p99_us":null},"socket_errors":{"connect":0,"read":0,"write":0,"timeout":0,"total":0}});
