...
Validated package version: `0.3.0`.
...
`v0.3.0` was published on 2026-07-19. Release workflow `29685974747`
published the crate, created the GitHub Release, uploaded Linux, macOS (Intel
and Apple Silicon), and Windows artifacts, updated the Homebrew tap, and
deployed the website and versioned user-guide references. The independent-server
accuracy matrix remains a post-release follow-up.
